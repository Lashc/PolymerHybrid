// This program is used to view and record video from a camera and
// measure temperature from a temperature sensor.  It's specifically
...
int main(int argc, char** argv) {
    // Verify usage: ./viewRecordVideo videoFilename
    if (argc != 2)
        return -1;    
    ...
    for(;;)
    {
        ...
        // Put the temperature as an overlay on the frame and show and save the frame
        #ifdef __arm__
