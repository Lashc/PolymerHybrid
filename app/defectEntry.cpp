...
DefectEntry::DefectEntry(const QStringList& labels, QWidget* parent)
    : DataEntry(labels, parent)
{
    ...
    lineEditLayout->addWidget(new QLabel(labels[0]), 0, 0);
    lineEditLayout->addWidget(printIDEdit, 0, 1);
    lineEditLayout->addWidget(new QLabel(labels[1]), 1, 0);
